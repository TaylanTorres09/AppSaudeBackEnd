...
//PainEducation
const PainEducation = require('../controllers/painEducationController')
...
routes
    ...
    //PainEducation
    .get('/api/PainEducation/news', PainEducation.allNews)
    .post('/api/PainEducation/insertnews', PainEducation.createNews)
